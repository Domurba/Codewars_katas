#2021-08-23 10:42:45.248000+00:00
"""# The Situation
...
def sort_the_pile(pile_of_towels, weekly_used_towels):
    for used_towels in weekly_used_towels:
        if used_towels == 0: continue
        old_towels = pile_of_towels[- used_towels:]
        pile_of_towels = pile_of_towels[:-used_towels or None]
        old_towels.sort(reverse = True)
        pile_of_towels.extend(old_towels)
        old_towels = [] 
